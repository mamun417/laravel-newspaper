...
class EnCategoryController extends Controller
{
    public function index()
    {
        ...
        return view('backend.settings.en_category_list', compact('categories'));

    }

    public function create()
    {
        return view('backend.settings.en_category_create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.settings.en_category_edit',compact('category'));
    }
