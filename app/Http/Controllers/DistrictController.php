...
class DistrictController extends Controller
{
    public function index()
    {
        ...
        return view('backend.settings.district_list', compact('districts'));
    }

    public function create()
    {
        $divisions = Division::where('deletable', 1)->get();
        return view('backend.settings.district_create', compact('divisions'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.settings.district_edit', compact('district', 'divisions'));
    }
