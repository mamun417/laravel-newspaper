...
class MonthlyFolderController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.settings.monthly_folder_list', compact('folders'));
    }

    public function create()
    {
        return view('backend.settings.monthly_folder_create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.settings.monthly_folder_edit', compact('folder'));
    }
