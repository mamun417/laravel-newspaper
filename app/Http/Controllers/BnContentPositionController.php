...
//        }
    ...
    public function getChangePosition($id){
        ...
        if(!empty($news_position->content_ids)){
            ...
            $allnews = BnContent::select('content_id', 'content_heading')->whereIn('content_id', $content_ids)->orderByRaw(DB::raw("FIELD(content_id, $news_position->content_ids)"))->take('6')->get();
        }
