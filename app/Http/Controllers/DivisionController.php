...
class DivisionController extends Controller
{
    public function index()
    {
        ...
        return view('backend.settings.division_list', compact('divisions'));
    }

    public function create()
    {
        return view('backend.settings.division_create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.settings.division_edit', compact('division'));
    }
