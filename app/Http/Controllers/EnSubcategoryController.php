...
class EnSubcategoryController extends Controller
{
    public function index()
    {
        ...
        return view('backend.settings.en_subcategory_list', compact('subcategories'));
    }

    public function create()
    {
        $categories = EnCategory::where('deletable', 1)->get();
        return view('backend.settings.en_subcategory_create', compact('categories'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.settings.en_subcategory_edit', compact('categories', 'subcategory'));
    }
