...
class UpozillaController extends Controller
{
    public function index()
    {
        ...
        return view('backend.settings.upozilla_list', compact('upozillas'));
    }

    public function create()
    {
        $districts = District::where('deletable', 1)->orderBy('district_name')->get();
        return view('backend.settings.upozilla_create', compact('districts'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.settings.upozilla_edit', compact('upozilla', 'districts'));
    }
