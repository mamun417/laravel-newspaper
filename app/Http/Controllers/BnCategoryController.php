...
class BnCategoryController extends Controller
{
    public function index()
    {
        ...
        return view('backend.settings.category_list', compact('categories'));
    }

    public function create()
    {
        return view('backend.settings.category_create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.settings.category_edit',compact('category'));
    }
