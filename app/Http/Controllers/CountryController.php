...
class CountryController extends Controller
{
    public function index()
    {
        ...
        return view('backend.settings.country_list', compact('countries'));
    }

    public function create()
    {
        return view('backend.settings.country_create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.settings.country_edit', compact('country'));
    }
