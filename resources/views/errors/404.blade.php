    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-8 col-sm-offset-2 text-center">
                ...
                <h1>পাওয়া যায়নি</h1>
                <p>
                    আপনি যে বিষয়টি অনুসন্ধান করছেন তা খুজে পাওয়া যায়নি। বিষয়টি সম্ভবত  ইউএসএ বাংলা নিউজের সাথে সংশ্লিষ্ট নয় অথবা আপনি ভুলভাবে অনুসন্ধান করছেন। অনুগ্রহ করে আপনার অনুসন্ধান বিষয়টি সম্বন্ধে নিশ্চিত হোন
                </p>
    ...
    <div class="row">
        <div class="col-sm-12">
            <ul class="row list-unstyled nav navbar">
                @php($contents = \App\Http\Controllers\BnHelperController::getLatestContent(12))
