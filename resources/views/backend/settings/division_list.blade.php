...
<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1 style="display: inline-block;">Division</h1>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              ...
              <a href="{{ url('backend/divisions/create') }}" class="btn btn-primary btn-sm pull-right"><i class="fa fa-plus"></i></a>
            </div>
            <!-- /.box-header -->
              ...
              <tbody>
                @foreach($divisions as $no => $division)
                  <tr>
                    ...
                    <td>
                      <a href="{{ action('DivisionController@edit', $division->division_id) }}" class="btn btn-warning btn-xs">
                        <i class="fa fa-pencil"></i>
                      </a>
                      <form action="{{ action('DivisionController@destroy', $division->division_id) }}" method="post" style="display: inline">
                      {{ csrf_field() }}
                      {{ method_field('DELETE') }}
