            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">En Tag Insert</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form action="{{ action('EnTagController@store') }}" method="post" enctype="multipart/form-data" class="form-horizontal col-sm-offset-1">
                        {{ csrf_field() }}
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="file" name="tagPhoto" id="tagPhoto" class="form-control col-sm-6" style="padding: 0 12px;">
                                </div>
                            </div>
