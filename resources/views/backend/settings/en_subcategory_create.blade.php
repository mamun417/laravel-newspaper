...
@section('title', 'En Subcategory Create')

@section('content')
    <!-- Content Header (Page header) -->
    <section class="content-header">
        <h1>En Subcategory</h1>
        <ol class="breadcrumb">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Create En Subcategory</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form action="{{ action('EnSubcategoryController@store') }}" method="post" class="form-horizontal col-sm-offset-1">
                        {{ csrf_field() }}
                        <div class="box-body">
