      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="{{ action('BnSubcategoryController@update', $subcategory->subcat_id) }}" method="post" class="form-horizontal col-sm-offset-1">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="subcategoryName" class="col-sm-2 control-label">Subategory name <span class="required">*</span></label>

                  <div class="col-sm-6">
                    <input type="text" name="subcategoryName" class="form-control" id="subcategoryName" value="{{ $subcategory->subcat_name }}">
                    @if($errors->has('subcategoryName')) <span class="text-danger">{{ $errors->first('subcategoryName') }}</span> @endif
                  </div>
                </div>
                <div class="form-group">
                  <label for="subcategoryNameBn" class="col-sm-2 control-label">Subcategory name (Bn) <span class="required">*</span></label>

                  <div class="col-sm-6">
                    <input type="text" name="subcategoryNameBn" class="form-control" id="subcategoryNameBn" value="{{ $subcategory->subcat_name_bn }}">
                    @if($errors->has('subcategoryNameBn')) <span class="text-danger">{{ $errors->first('subcategoryNameBn') }}</span> @endif                    
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="subcategoryPosition" class="col-sm-2 control-label">Subcategory Position</label>
                  <div class="col-sm-6">
