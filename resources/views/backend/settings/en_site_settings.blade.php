...
@section('title', 'En Site Settings')

@section('content')
    <!-- Content Header (Page header) -->
    <section class="content-header">
        <h1 style="display: inline-block;">En Site Settings</h1>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">En Site Settings</li>
        </ol>
    </section>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    <!-- form start -->
                    <form action="{{ action('EnSiteSettingsController@store') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                        {{ csrf_field() }}
                        <div class="box-body">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tab_1">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" name="siteName" id="siteName" placeholder="Site Name" type="text" value="{{ $siteSettings->site_name or '' }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <span class="text-muted">(Maximum in 30Kb)</span>
                                            </div>
                                            <div class="col-sm-3">
                                    ...
                                    <div class="tab-pane" id="tab_2">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" name="metaKeyword" id="metaKeyword" placeholder="Meta Keyword" type="text" value="{{ $siteSettings->meta_keyword }}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="tab-pane" id="tab_4">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6" id="fbShow">
                                                    <input class="form-control" name="socialLinks[facebook]" id="socialLinks[facebook]" placeholder="Facebook Link" type="text" value="{{ $socialLinks['facebook'] or '' }}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6" id="twitShow">
                                                    <input class="form-control" name="socialLinks[twitter]" id="socialLinks[twitter]" placeholder="Twiiter Link" type="text" value="{{ $socialLinks['twitter'] or '' }}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6" id="gPlusShow">
                                                    <input class="form-control" name="socialLinks[google]" id="socialLinks[google]" placeholder="Google Plus Link" type="text" value="{{ $socialLinks['google'] or '' }}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6" id="youtubeShow">
                                                    <input class="form-control" name="socialLinks[youtube]" id="socialLinks[youtube]" placeholder="Youtube Link" type="text" value="{{ $socialLinks['youtube'] or '' }}">
                                                </div>
                                            </div>
                                            {{--<div class="form-group">
                                                ...
                                                <div class="col-sm-6" id="instagramShow">
                                                    <input class="form-control" name="socialLinks[instagram]" id="socialLinks[instagram]" placeholder="Instagram Link" type="text" value="{{ $socialLinks['instagram'] or '' }}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6" id="linkedInShow">
                                                    <input class="form-control" name="socialLinks[linkedin]" id="socialLinks[linkedin]" placeholder="Linked In Link" type="text" value="{{ $socialLinks['linkedin'] or '' }}">
                                                </div>
                                            </div>--}}
                                        </div>
                                        <!-- /.tab-pane -->
