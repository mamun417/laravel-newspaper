    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box box-info">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form action="{{ action('BnCategoryController@update', $category->cat_id) }}" method="post" class="form-horizontal col-sm-offset-1">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <input type="text" name="categoryNameBn" class="form-control" id="categoryNameBn" value="{{ $category->cat_name_bn }}">
              ...
              <div class="form-group">
                <div class="col-sm-offset-3 col-sm-6">
                  ...
                  <a href="{{ route('bn-categories.index') }}" type="button" class="btn btn-default">Cancel</a>
                </div>
              </div>
            </div>
            <!-- /.box-body -->
