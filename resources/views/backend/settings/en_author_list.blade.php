            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                        ...
                        <a href="{{ url('backend/en-authors/create') }}" class="btn btn-primary btn-sm pull-right"><i class="fa fa-plus"></i></a>
                    </div>
                    <!-- /.box-header -->
                    <table class="table table-bordered table-hover">
                        ...
                        @foreach($authors as $no => $author)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ action('EnAuthorController@edit', $author->author_id) }}" class="btn btn-warning btn-xs">
                                        <i class="fa fa-pencil"></i>
                                    </a>
                                    <form action="{{ action('EnAuthorController@destroy', $author->author_id) }}" method="post" style="display: inline">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}
