      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview {{ $cur_controller_name == 'BnContentController' || $cur_controller_name == 'BnContentPositionController'?'active':'' }}">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ $cur_route_name == 'bn-contents.index'? 'active':'' }}">
              <a href="{{ url('backend/bn-contents') }}"><i class="fa fa-file-o"></i> News list</a>
            </li>
            <li class="{{ $cur_route_name == 'bn-content-position.index' || $cur_route_name == 'bn-content-position.create'? 'active':'' }}">
        ...
        <li class="treeview {{ $cur_controller_name == 'EnContentController' || $cur_controller_name == 'EnContentPositionController'? 'active':'' }}">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ $cur_route_name == 'en-content-position.index' || $cur_route_name == 'en-content-position.create'? 'active':'' }}">
        ...
        <li class="treeview {{ $cur_controller_name == 'ManualPhotoController'? 'active':'' }}">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ $cur_route_name == 'manual-photos.index'? 'active':'' }}">
        ...
        <li class="treeview {{ $cur_controller_name == 'ManualDocController'? 'active':'' }}">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ $cur_route_name == 'manual-docs.index'? 'active':'' }}">
        ...
        <li class="treeview {{$bn_setting_active}}">
          ...
          <ul class="treeview-menu">
            <li class="{{ $cur_route_name == 'bn-tags.index' || $cur_route_name == 'bn-tags.create'? 'active':'' }}">
              <a href="{{ url('backend/bn-tags') }}"><i class="fa fa-tag"></i> Bn Tag</a>
            </li>
            <li class="{{ $cur_route_name == 'bn-categories.index' || $cur_route_name == 'bn-categories.create'? 'active':'' }}">
              <a href="{{ url('backend/bn-categories') }}"><i class="fa fa-plus-square"></i> Bn Category</a>
            </li>
            <li class="{{ $cur_route_name == 'bn-subcategories.index' || $cur_route_name == 'bn-subcategories.create'? 'active':'' }}">
              <a href="{{ url('backend/bn-subcategories') }}"><i class="fa fa-file-o"></i> Bn Subcategory</a>
            </li>
            <li class="{{ $cur_route_name == 'bn-authors.index' || $cur_route_name == 'bn-authors.create'? 'active':'' }}">
              <a href="{{ url('backend/bn-authors') }}"><i class="fa fa-file-o"></i> Bn Author</a>
            </li>
            <li class="{{ $cur_route_name == 'countries.index' || $cur_route_name == 'countries.create'? 'active':'' }}">
              <a href="{{ url('backend/countries') }}"><i class="fa fa-plus-square"></i> Country</a>
            </li>
            <li class="{{ $cur_route_name == 'divisions.index' || $cur_route_name == 'divisions.create'? 'active':'' }}">
            ...
            <li class="{{ $cur_route_name == 'upozillas.index' || $cur_route_name == 'upozillas.create'? 'active':'' }}">
              <a href="{{ url('backend/upozillas') }}"><i class="fa fa-file-o"></i> Upozilla list</a>
            </li>
            <li class="{{ $cur_route_name == 'monthly-folders.index' || $cur_route_name == 'monthly-folders.create'? 'active':'' }}">
        ...
        <li class="treeview {{$en_setting_active}}">
          ...
          <ul class="treeview-menu">
            <li class="{{ $cur_route_name == 'en-tags.index' || $cur_route_name == 'en-tags.create'? 'active':'' }}">
              <a href="{{ url('backend/en-tags') }}"><i class="fa fa-tag"></i> En Tag</a>
            </li>
            <li class="{{ $cur_route_name == 'en-categories.index' || $cur_route_name == 'en-categories.create'? 'active':'' }}">
              <a href="{{ url('backend/en-categories') }}"><i class="fa fa-plus-square"></i> En Category</a>
            </li>
            <li class="{{ $cur_route_name == 'en-subcategories.index' || $cur_route_name == 'en-subcategories.create'? 'active':'' }}">
              <a href="{{ url('backend/en-subcategories') }}"><i class="fa fa-file-o"></i> En Subcategory</a>
            </li>
            <li class="{{ $cur_route_name == 'en-authors.index' || $cur_route_name == 'en-authors.create'? 'active':'' }}">
        ...
        <li class="treeview {{ $cur_controller_name == 'MisUserController' || $cur_controller_name == 'UserController'? 'active':'' }}">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ $cur_route_name == 'mis-users.index' || $cur_route_name == 'mis-users.create'? 'active':'' }}">
              <a href="{{ url('backend/mis-users') }}"><i class="fa fa-file-o"></i> MIS user</a>
            </li>
            @if(auth()->user()->role == 1)
              <li class="{{ $cur_route_name == 'users.index' || $cur_route_name == 'users.create'? 'active':'' }}">
