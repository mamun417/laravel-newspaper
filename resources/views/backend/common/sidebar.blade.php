...
<aside class="main-sidebar">
    ...
    <!-- /.search form -->
        ...
        <ul class="sidebar-menu">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{ $cur_route_name == 'bn-content-position.index' || $cur_route_name == 'bn-content-position.create' || $cur_route_name == 'bn-content-position.edit' || Route::current()->uri == 'backend/bn-content-position/change/{id}'? 'active':'' }}">
                        <a href="{{ url('backend/bn-content-position/change/1') }}"><i class="fa fa-file-o"></i> News
                            position</a>
                    </li>
                </ul>
            </li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li class="{{ $cur_route_name == 'en-contents.create'? 'active':'' }}">
                        <a href="{{ url('backend/en-contents/create') }}"><i class="fa fa-plus-square"></i> Add English
                            News</a>
                    </li>
                    ...
                    <li class="{{ $cur_route_name == 'en-content-position.index' || $cur_route_name == 'en-content-position.create' || $cur_route_name == 'en-content-position.edit' || Route::current()->uri == 'backend/en-content-position/change/{id}'? 'active':'' }}">
                        <a href="{{ url('backend/en-content-position/change/3') }}"><i class="fa fa-file-o"></i> English
                            News position</a>
                    </li>
                </ul>
            </li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li class="{{ $cur_route_name == 'manual-photos.create'? 'active':'' }}">
                        <a href="{{ url('backend/manual-photos/create') }}"><i class="fa fa-plus-square"></i> Add New
                            Photo</a>
                    </li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li class="{{ $cur_route_name == 'manual-docs.create'? 'active':'' }}">
                        <a href="{{ url('backend/manual-docs/create') }}"><i class="fa fa-plus-square"></i> Add New
                            Document</a>
                    </li>
            ...
            <li class="treeview {{ $cur_controller_name == 'AdsManagementController'? 'active':'' }}">
                <a href="#">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li class="{{ $cur_route_name == 'top_ad' || $cur_route_name == 'footer_ad' ||
                        ($cur_route_name == 'ads.edit' AND (Request::segment(3) == 'top_ad' ||
                        Request::segment(3) == 'footer_ad'))? 'active':'' }}">

                        <a href="#"><i class="fa fa-plus-square"></i> All Page</a>
                        <ul class="treeview-menu">
                            <li class="{{ $cur_route_name == 'top_ad' || Request::segment(3) == 'top_ad'? 'active':'' }}">
                                <a href="{{ route('top_ad') }}"><i class="fa fa-file-o"></i> Top Ad</a>
                            </li>
                            <li class="{{ $cur_route_name == 'footer_ad' || Request::segment(3) == 'footer_ad'? 'active':'' }}">
                                <a href="{{ route('footer_ad') }}"><i class="fa fa-file-o"></i> Footer Ad</a>
                            </li>
                        </ul>
                    </li>
                    <li class="{{ $cur_route_name == 'after_lead_news' || $cur_route_name == 'before_sports_news' ||
                        ($cur_route_name == 'ads.edit' AND (Request::segment(3) == 'after_lead_news' ||
                        Request::segment(3) == 'before_sports_news' ))? 'active':'' }}">

                        <a href="#"><i class="fa fa-plus-square"></i> Home Page</a>
                        <ul class="treeview-menu">
                            <li class="{{ $cur_route_name == 'after_lead_news' || Request::segment(3) == 'after_lead_news'? 'active':'' }}">
                                <a href="{{ route('after_lead_news') }}"><i class="fa fa-file-o"></i> After Lead News</a>
                            </li>
                            <li class="{{ $cur_route_name == 'before_sports_news' || Request::segment(3) == 'before_sports_news'? 'active':'' }}">
                                <a href="{{ route('before_sports_news') }}"><i class="fa fa-file-o"></i> Before Sports News</a>
                            </li>
                        </ul>
                    </li>
                    <li class="{{ $cur_route_name == 'category_right_top' || $cur_route_name == 'category_right_bottom' ||
                        ($cur_route_name == 'ads.edit' AND (Request::segment(3) == 'category_right_top' ||
                        Request::segment(3) == 'category_right_bottom' ))? 'active':'' }}">

                        <a href="#"><i class="fa fa-plus-square"></i> Category Page</a>
                        <ul class="treeview-menu">
                            <li class="{{ $cur_route_name == 'category_right_top' || Request::segment(3) == 'category_right_top'? 'active':'' }}">
                                <a href="{{ route('category_right_top') }}"><i class="fa fa-file-o"></i> Right Top</a>
                            </li>
                            <li class="{{ $cur_route_name == 'category_right_bottom' || Request::segment(3) == 'category_right_bottom'? 'active':'' }}">
                                <a href="{{ route('category_right_bottom') }}"><i class="fa fa-file-o"></i> Right Bottom</a>
                            </li>
                        </ul>
                    </li>
                    <li class="{{ $cur_route_name == 'news_details_right_top' || $cur_route_name == 'news_details_right_bottom' ||
                        ($cur_route_name == 'ads.edit' AND (Request::segment(3) == 'news_details_right_top' ||
                        Request::segment(3) == 'news_details_right_bottom' ))? 'active':'' }}">

                        <a href="#"><i class="fa fa-plus-square"></i> News Details Page</a>
                        <ul class="treeview-menu">
                            <li class="{{ $cur_route_name == 'news_details_right_top' || Request::segment(3) == 'news_details_right_top'? 'active':'' }}">
                                <a href="{{ route('news_details_right_top') }}"><i class="fa fa-file-o"></i> Right Top</a>
                            </li>
                            <li class="{{ $cur_route_name == 'news_details_right_bottom' || Request::segment(3) == 'news_details_right_bottom'? 'active':'' }}">
                                <a href="{{ route('news_details_right_bottom') }}"><i class="fa fa-file-o"></i> Right Bottom</a>
                            </li>
                        </ul>
                    </li>
            ...
            <li class="treeview {{$bn_setting_active}}">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{ $cur_route_name == 'bn-site-settings.index'? 'active':'' }}"><a
                                href="{{ url('backend/bn-site-settings') }}">
            ...
            <li class="treeview {{$en_setting_active}}">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{ $cur_route_name == 'en-site-settings.index'? 'active':'' }}"><a
                                href="{{ url('backend/en-site-settings') }}">
