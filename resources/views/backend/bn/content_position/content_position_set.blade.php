    ...
    <script>
        ...
        function saveData(posId) {
            ...
            if(data.length == 0){
                ...
                var id = posId;
                $.post('{{ url("backend/bn-position/change") }}', {'_token': '{{ csrf_token() }}', "data": data, 'id': id}, function(d){
        ...
        $(function() {
            $("#newsHeading").autocomplete({ // For news title autocomplete
                source: function(request, response) {
                    $.get("{{ url('backend/bn-content-position/keyword') }}", { posId: $('#positionId').val(), term: $('#newsHeading').val() }, response);
                },
                minLength: 1,
        ...
        $(function() {
            $('#positionName').change(function() {
                ...
                //alert(position);
                $.get('{{ url("backend/bn-populate-position") }}', {'position': position}, function (data) {
