...
<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1 style="display: inline-block;">News List</h1>
          ...
          <div class="box box-info">
            <div class="box-header with-border">
                <div class="row" style="margin-bottom: 5px;">
                    <div class="col-sm-12">
                        <form action="{{ action('BnContentController@index') }}" method="get">
                            ...
                            <div class="col-sm-2">
                                <div class="btn-group btn-group-justified" role="group" aria-label="...">
                                    ...
                                    <div class="btn-group" role="group">
                                        <a href="{{ url('backend/bn-contents/create') }}" class="btn btn-primary btn-sm btn-block"><i class="fa fa-plus"></i></a>
                                    </div>
                                </div>
                            </div>
                        </form>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <form action="{{ action('BnContentController@index') }}" method="get" class="">
                            ...
                            <div class="col-sm-2">
                                <div class="btn-group btn-group-justified" role="group" aria-label="...">
                                    ...
                                    <div class="btn-group" role="group">
                                        <a href="{{ url('backend/bn-contents') }}" class="btn bg-aqua-gradient"><i class="fa fa-refresh"></i></a>
                                    </div>
                                </div>
                            </div>
                        </form>
                ...
                @foreach($contents as $no => $content)
                  <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ action('BnContentController@destroy', $content->content_id) }}" method="post" style="display: inline">
                        {{ csrf_field() }}
                        {{ method_field('DELETE') }}
    ...
    <div class="modal fade" id="quickUpdate" tabindex="-1" role="dialog">
      <div class="modal-dialog" role="document" style="width: 550px;">
        <form action="{{ action('BnContentController@postQuickUpdate') }}" method="post">
                                ...
                                <div class="input-group">
                                    ...
                                    <select id="specialCategory" name="specialCategory" class="form-control select2" style="width:100%;">
                                        @foreach($specialCategories as $specialCategory)
                                            <option value="{{ $specialCategory->cat_id }}">{{ $specialCategory->cat_name_bn }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
