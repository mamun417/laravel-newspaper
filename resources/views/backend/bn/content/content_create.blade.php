...
<!-- Content Header (Page header) -->
    ...
    <section class="content">
      ...
      <div class="row">
        <!-- form start -->
        <form action="{{ action('BnContentController@store') }}" method="post" enctype="multipart/form-data">
	                			...
	                			{{--<div class="box box-success text-center">--}}
									...
									{{--<div class="row">--}}
										{{--<div class="col-sm-4">--}}
											...
											{{--<label for="smallImage" class="btn bg-purple btn-flat">Local</label>--}}
										...
										{{--<div class="col-sm-8">--}}
											{{--<input type="text" name="ImageSMCaption" class="form-control" id="ImageSMCaption" placeholder="Small image caption" value="{{ old('ImageSMCaption') }}" style="margin-top: 5px;">--}}
										{{--</div>--}}
									{{--</div>--}}
	                			{{--</div>--}}
	                		{{--</div>--}}
							...
							<div class="col-sm-9">
								<select name="specialCategory" id="specialCategory" class="form-control">
									...
									@foreach($specialCategories as $specialCategory)
										<option value="{{ $specialCategory->cat_id }}"{{ old('specialCategory') == $specialCategory->cat_id ? ' selected' : '' }}>{{ $specialCategory->cat_name_bn}}</option>
									@endforeach
								</select>
							</div>
						</div>
							...
							<div class="col-sm-9">
								<select name="uploader" id="uploader" class="form-control">
									@foreach($mis_uploaders as $mis_uploader)
										<option value="{{ $mis_uploader->user_id }}"{{ $mis_uploader->user_id == auth()->user()->id ? ' selected' : '' }}>{{ $mis_uploader->user_name }}</option>
									@endforeach
								</select>
								...
								<div class="form-group">
									<div class="well well-sm no-margin">
										<div class="btn-group radioBtn">
											<a class="btn btn-primary btn-sm notActive" data-toggle="scroll" data-title="2">Yes</a>
											<a class="btn btn-primary btn-sm active" data-toggle="scroll" data-title="1">No</a>
										</div>
...
@section('custom-js')
	...
	<script type="text/javascript">
        ...
        $.get('{{ url("backend/subcat-populate?cat_id=") }}'+catId, function(data){
