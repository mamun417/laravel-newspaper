...
<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1 style="display: inline-block;">Manual Photo</h1>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              ...
              <a href="{{ url('backend/manual-photos/create') }}" class="btn btn-primary btn-sm pull-right"><i class="fa fa-plus"></i></a>
            </div>
            <!-- /.box-header -->
              ...
              <tbody>
                @foreach($photos as $photo)
                  <tr>
                    ...
                    <td>
                      <a href="{{ action('ManualPhotoController@edit', $photo->photo_id) }}" class="btn btn-warning btn-xs">
                        <i class="fa fa-pencil"></i>
                      </a>
                      <form action="{{ action('ManualPhotoController@destroy', $photo->photo_id) }}" method="post" style="display: inline">
                      {{ csrf_field() }}
                      {{ method_field('DELETE') }}
