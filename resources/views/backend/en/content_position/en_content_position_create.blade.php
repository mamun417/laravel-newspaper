...
@section('title', 'En Content Position Create')
...
<!-- Content Header (Page header) -->
    ...
    <section class="content">
        <div class="row">
            <form action="{{ action('EnContentPositionController@store') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="col-sm-12">
