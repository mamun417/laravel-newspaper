            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header with-border">
                      ...
                      <a href="{{ url('backend/en-content-position/create') }}" class="btn btn-primary btn-sm pull-right"><i class="fa fa-plus"></i></a>
                    </div>                
                        ...
                        <table class="table table-hover table-striped">
                            ...
                            @foreach($content_positions as $content_position)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ action('EnContentPositionController@getChangePosition', $content_position->position_id) }}" class="btn btn-xs btn-success"><i class="fa fa-edit"></i> Change Position</a>

                                        @if(auth()->user()->role == 1)
                                            <a href="{{ action('EnContentPositionController@edit', $content_position->position_id) }}" class="btn btn-xs btn-warning"><i class="fa fa-edit"></i> Edit </a>
                                            <form action="{{ action('EnContentPositionController@destroy', $content_position->position_id) }}" method="post" style="display: inline;">
                                                {{ csrf_field() }}
                                                {{ method_field('delete') }}
