        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="breadcrumb ">
                    <ul>
                        <li><a href="{{ url('/en') }}"><strong >Home</strong></a></li>
                        <li><a href="{{ url('/en/' . $category->cat_slug) }}"><strong >{{ $category->cat_name }}</strong></a></li>
                        <li><a href="{{ url('/en/' . $category->cat_slug . '/' . $subcategory->subcat_slug) }}"><strong >{{ $subcategory->subcat_name }}</strong></a></li>
                    </ul>
                </div>
            </div>
        </div>
