                    ...
                    <div class="row">
                            ...
                            <div class="ex-inputs">
                                <div class="ex-inputs-header">
                                    ...
                                    <div class="input-group">
                                        <label for="dateFrom" class="input-group-addon ">তারিখ  <i class="fa fa-calendar"></i></label>
                                        <input name="dateFrom" class="form-control ex-inputs-start" id="dateFrom" type="text" value="{{ $dateFrom or '' }}" placeholder="তারিখ">
                                        <label for="dateTo" class="input-group-addon">থেকে  <i class="fa fa-calendar"></i></label>
                                        <input name="dateTo" class="form-control ex-inputs-end" id="dateTo" type="text" value="{{ $dateTo or '' }}" placeholder="পর্যন্ত " >
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-4">
                            <div class="input-group" style="margin-bottom:8px;">
                                <input type="text" name="keyword" value="{{ $keyword or '' }}" class="form-control" placeholder="আপনি কী খুঁজছেন?">
                        ...
                        <div class="col-sm-1">
                            <a href="{{ url('/archive') }}" class="btn btn-primary">সব সংবাদ</a>
                        </div>
                    </div>
                </form>
            </div>
