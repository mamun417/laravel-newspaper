        ...
        <div class="pl-3 py-3 border-light border-bottom mb-3 bg-light">
            <div class="container">
                <ol class="list-unstyled list-inline m-0">
                    ...
                    »
                    <li class="d-inline-block">আর্কাইভ</li>
                </ol>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-3">
                    <form action="" method="get" class="border border-light mb-4 shadow-sm p-4 rounded">
                        <div class="form-group">
                            <div class="input-group">
                                <div class="input-group-append">
                                    <span id="" class="btn border border-right-0 rounded-left text-dark">তারিখ </span>
                                </div>
                                <input type="date" placeholder="অনুসন্ধান করতে লিখুন..." class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="category" class="sr-only">তারিখ</label>
                        ...
                        <div class="form-group">
                            <input type="text" name="keyword" id="text_search" value="{{ $keyword or '' }}" placeholder="আপনি কী খুঁজছেন?" class="form-control">
                        </div>
                        <div>
                            <button type="submit" class="btn btn-theme btn-block">খুজুন</button>
                        </div>
                    </form>
                </div>
                <div class="col-sm-9">
                        ...
                        @foreach($contents as $content)
                            ...
                            <a href="{{ $sURL }}" class="media border-bottom mb-3 pb-3 text-dark w-100 link">
                                ...
                                <div class="media-body">
                                    <small class="text-muted small" style="font-size:12px;">{{ fFormatDateEn2Bn(date('d F Y, h:i a, l', strtotime($content->created_at))) }}</small>
